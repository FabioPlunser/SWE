...
public class DashBoardController {
    ...
    public RestResponseEntity getDashboardData(
            Person person
    ) {
...
//            @RequestBody final UUID id
    ...
    @PrincipalRequired(Person.class)
    @RequestMapping(value = "/add-to-dashboard", method = RequestMethod.DELETE)
    public RestResponseEntity removePlantFromDashboard(
            Person person
//            @RequestBody final UUID id
    ) {
        throw new NotImplementedException();
