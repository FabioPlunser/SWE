...
public enum Permission implements GrantedAuthority {
  ...
  public static Set<Permission> defaultPermissions() { return Set.of(USER); }

  public static Set<GrantedAuthority> defaultAuthorities() {
    return Set.of(USER);
  }

  public static Set<Permission> adminPermissions() { return Set.of(ADMIN); }
  ...
  public static Set<Permission> allPermissions() { return ALL_PERMISSIONS; }
