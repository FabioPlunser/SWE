...
public class ListResponse<T extends Serializable>
    extends RestResponse implements Serializable {
  @JsonInclude
  @Override
  ...
  @JsonInclude(JsonInclude.Include.NON_NULL) private List<T> items;

  /**
   * Indicate a successful fetch of items.
   * If items is null, an empty list will be sent to prevent problems on the
   * Front-End.
   *
