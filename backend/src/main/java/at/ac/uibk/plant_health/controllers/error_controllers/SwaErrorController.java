...
public class SwaErrorController implements ErrorController {
		...
		@PublicEndpoint
		@RequestMapping (
				value = AUTHENTICATION_ERROR_ENDPOINT, method = {GET, POST, PUT, PATCH, DELETE}
		)
		...
		@PublicEndpoint
		@RequestMapping (
				value = TOKEN_EXPIRED_ERROR_ENDPOINT, method = {GET, POST, PUT, PATCH, DELETE}
		)
		@ResponseStatus (HttpStatus.UNAUTHORIZED)
		public RestResponseEntity
		...
		@PublicEndpoint
		@RequestMapping (
				value = AUTHORIZATION_ERROR_ENDPOINT, method = {GET, POST, PUT, PATCH, DELETE}
		)
