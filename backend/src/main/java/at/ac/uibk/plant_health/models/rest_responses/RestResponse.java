...
public abstract class RestResponse implements Serializable {
   ...
   */
  @JsonInclude public abstract String getType();
  ...
  public RestResponseEntity toEntity() { return new RestResponseEntity(this); }
  // endregion

  // region Builder Customization
  public abstract static class RestResponseBuilder<
      C extends RestResponse, B extends RestResponseBuilder<C, B>> {
    /**
     * Indicate that the Operation succeeded.
     * Synonymous with {@link RestResponseBuilder#success}(true)
     */
    public B ok() { return this.success(true); }

    /**
     * Indicate that the Operation failed.
     * Synonymous with {@link RestResponseBuilder#success}(false)
     */
    public B error() { return this.success(false); }

    /**
     * Set the {@link RestResponse#success}-Flag of the {@link RestResponse}
     * that is being built. If the {@link RestResponse#statusCode} was not
     * already set, it is set according to the success-Parameter.
     *
    ...
    public B success(boolean success) {
      ...
      if (!this.statusCode$set)
        this.statusCode(successToStatusCode(success));
     ...
     *
     * @return The {@link RestResponseEntity} containing the built {@link
     *     RestResponse}.
     */
