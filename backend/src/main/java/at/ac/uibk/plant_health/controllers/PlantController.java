...
public class PlantController {
	...
	public RestResponseEntity scanQrCode(@RequestParam("plant-id") final String qrCode) {
	...
	@PublicEndpoint
	@RequestMapping(value = "/upload-picture", method = {RequestMethod.PUT, RequestMethod.POST})
	public RestResponseEntity uploadPlantPicture(
			@RequestParam("plant-id") final String qrCode, @RequestBody final String picture
	) {
		throw new NotImplementedException();
	}
	...
	public RestResponseEntity setSensorLimits(@RequestBody List<SensorLimits> limits) {
		throw new NotImplementedException();
	}

	@AnyPermission(Permission.GARDENER)
	@RequestMapping(
			value = "/set-transfer-interval", method = {RequestMethod.PUT, RequestMethod.POST}
	)
	public RestResponseEntity
	setTransferIntervals(
