...
public class ReflectionUtil {
   ...
   *
   * @implNote This method does no type checking, so please ensure that the
   * types can be converted or catch the arising Exception.
   * @param field The Runtime Field
   * @return The value of the field (or null if the field is not static).
   */
  @SneakyThrows
   ...
   * @return true if the variable can be assigned from the given field, false
   *     otherwise.
   */
  ...
  /**
   * Creates a Predicate that checks if the given field can be assigned to a
   * Variable of the given type.
   *
   * @param clazz The class of the variable are trying to assign the field to.
   * @return A Predicate that returns true if the variable can be assigned from
