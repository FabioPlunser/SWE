...
public class Person extends Authenticable implements Serializable {
   ...
   * This method is a renamed version of {@link Authenticable#getId()} so the ID
   * field will be included in the JSON-Serialization of a {@link Person}.
   *
   * @implNote This may return null if the {@link Person} was not saved to the
   * Database.
