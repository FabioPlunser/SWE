...
public class TokenExpiredResponse extends RestResponse {
		...
		public TokenExpiredResponse () { this.message = this.getType (); }
		...
		public static TokenExpiredResponse
		fromException (TokenExpiredException tokenExpiredException) {
		...
		public abstract static class TokenExpiredResponseBuilder<
			C extends TokenExpiredResponse, B
				extends TokenExpiredResponseBuilder<C, B>>
			extends RestResponseBuilder<C, B> {
				public TokenExpiredResponseBuilder<C, B>
				exception (TokenExpiredException tokenExpiredException) {
					this.message = tokenExpiredException.getMessage ();
					return this;
				}
		}
