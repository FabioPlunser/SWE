...
public class TestPersonServiceSecurity {
  ...
  public void loginWithValidCredentials() {
    ...
    Person person =
        new Person(username, StringGenerator.email(), password, Set.of());
  ...
  public void loginWithInvalidCredentials() {
    ...
    assertTrue(maybePersonAllWrong.isEmpty(),
               "Could login with completely different credentials");
    assertTrue(maybePersonUsernameWrong.isEmpty(),
               "Could login with wrong username");
    assertTrue(maybePersonPasswordWrong.isEmpty(),
  ...
  public void logout() {
    ...
    Optional<Person> maybeLoggedOutPerson =
        personService.findByUsernameAndToken(username, token);
    assertTrue(maybeLoggedOutPerson.isEmpty(),
  ...
  public void testPasswordHashingWithNullUpdate() {
    ...
    assertTrue(personService.update(person, null, null, null),
