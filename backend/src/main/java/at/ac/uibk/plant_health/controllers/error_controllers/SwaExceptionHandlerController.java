...
/**
 * Controller Advice for catching Exceptions and sending the appropriate
 * Responses.
 *
 * @author David Rieser
 */
...
public class SwaExceptionHandlerController
  ...
  public void handleTokenExpiredException(HttpServletRequest request,
  ...
  @ResponseStatus(HttpStatus.UNAUTHORIZED)
  public void
  handleAuthenticationException(HttpServletRequest request,
                                HttpServletResponse response,
  ...
  public void
  handleAccessDeniedException(HttpServletRequest request,
                              HttpServletResponse response,
