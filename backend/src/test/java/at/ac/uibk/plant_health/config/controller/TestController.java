...
public class TestController {
		public final static String TEST_ANONYMOUS_VALUE =
			"${swa.api.base:/api}/test";
		public final static String TEST_API_VALUE =
			"${swa.api.base:/api}/testAdmin";
		public final static String TEST_ADMIN_VALUE =
			"${swa.admin.base:/admin}/test";
