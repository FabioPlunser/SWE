...
public class PersonService {
   ...
   *
   * @implNote This method does not check if the current user is permitted to
   ...
   *     otherwise.
   */
  public boolean update(Person person, String username, String password,
   ...
   */
  public boolean update(UUID personId, String username,
                        Set<Permission> permissions, String password) {
    Optional<Person> maybePerson = findById(personId);
    return maybePerson
        .filter(person -> update(person, username, password, permissions))
        .isPresent();
  }
